...
public class RightBallRun extends ParallelCommandGroup {
  ...
  public RightBallRun(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem,
    ...
    addCommands(new IntakeCommand(intakeSubsystem, 0.85),
        new SpecialSpinUpCommand(shooterSubsystem, indexerSubsystem, 39000),
        new ToggleLightsCommand(backCamera, true),
        new TurretTrackingCommand(turretSubsystem, turretCamera),
        new SequentialCommandGroup(new TwoBallRun(driveSubsystem, backCamera), new BallDriveCommand(driveSubsystem, backCamera, 0.35, BallSide.LEFT, true, 5),
            new WaitCommand(0.5),
